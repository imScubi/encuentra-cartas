...
// esNativo/apiUrl viven en su propio archivo (no aquí) para no crear una
// importación circular: errorReporting.jsx también los necesita, y esta
// misma línea de arriba ya importa DE errorReporting.jsx.
export { esNativo, apiUrl } from "./entorno.js";
