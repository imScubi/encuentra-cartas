...
export const TrendingUp = crearIcono("TrendingUp", `<path d="M3.5 16 10 9.5l4 4 6.5-6.5"></path><path d="M15 6.5h5.5V12"></path>`);
export const Download = crearIcono("Download", `<path d="M12 3.5v11.5"></path><path d="M7.5 10.5 12 15l4.5-4.5"></path><path d="M4.5 17.5v1.5A1.5 1.5 0 0 0 6 20.5h12a1.5 1.5 0 0 0 1.5-1.5v-1.5"></path>`);

// ---- Íconos de emblema por TCG (botón flotante de notificaciones,
// personalizable en Apariencia -- ver theme.js TEMA_ICONO_KEY) ----
// A diferencia de crearIcono (íconos de trazo, fill="none"), estos son
// figuras sólidas -- un emblema se ve como una silueta rellena, no como
// un dibujo de líneas. Aproximaciones dibujadas a mano por Claude a
// partir de lo que el dueño compartió (no son el archivo original
// pixel por pixel); si más adelante consigue mandar los archivos reales,
// solo hay que reemplazar el `innerSvg` de aquí abajo.
function crearIconoSolido(nombre, innerSvg, viewBox = "0 0 24 24") {
  const Icono = React.forwardRef(function Icono(
...
// Pokémon: la pokébola de siempre -- de trazo (fill none), no sólida,
// porque así se ve el emblema real (un anillo, no un disco).
export const EmblemaPokemon = crearIcono("EmblemaPokemon", `<circle cx="12" cy="12" r="8.6"></circle><path d="M3.4 12h5.6"></path><path d="M15 12h5.6"></path><circle cx="12" cy="12" r="2.7"></circle>`);

// Magic: silueta del símbolo de planeswalker (la "corona" de 5 picos que
// termina en una punta abajo).
export const EmblemaMagic = crearIconoSolido("EmblemaMagic", `<path d="M12 1.5 14 8.3 16.6 5.6 17.3 9.7 21 8 21 9.2C21 14.7 18 17.7 14.3 19.2 13.4 21 12.7 22 12 22.5 11.3 22 10.6 21 9.7 19.2 6 17.7 3 14.7 3 9.2L3 8 6.7 9.7 7.4 5.6 10 8.3Z"></path>`);

// One Piece: brújula/compás (círculos concéntricos + aguja) -- el emblema
// que el dueño asoció a este TCG.
export const EmblemaOnePiece = crearIcono("EmblemaOnePiece", `<circle cx="12" cy="12" r="9.2"></circle><circle cx="12" cy="12" r="6.6" stroke-width="1"></circle><circle cx="12" cy="12" r="4" stroke-width="0.8"></circle><path d="M12 12 19.5 3.8 13.6 12Z" fill="currentColor" stroke="none"></path><path d="M12 12 4.5 20.2 10.4 12Z" fill="currentColor" stroke="none"></path><circle cx="12" cy="12" r="1.1" fill="currentColor" stroke="none"></circle>`);

// Riftbound: remolino de 5 aspas (una figura, repetida y rotada 5 veces
// alrededor del centro).
export const EmblemaRiftbound = crearIconoSolido("EmblemaRiftbound", `<g>${[0, 72, 144, 216, 288].map((deg) => `<path transform="rotate(${deg} 12 12)" d="M12 12C12 7.4 14.6 4 19.5 2.8 16.2 5.6 14 8.6 12 12Z"></path>`).join("")}</g>`);

// Lorcana: diamante/estrella vertical con dos alas envolventes en
// simetría rotacional de 180° -- inspirado en el emblema de tinta que
// usa Lorcana.
export const EmblemaLorcana = crearIconoSolido("EmblemaLorcana", `<path d="M12 1C13.8 6.6 15.6 8.8 12 12 15.6 15.2 13.8 17.4 12 23 10.2 17.4 8.4 15.2 12 12 8.4 8.8 10.2 6.6 12 1Z"></path><path d="M12 12C9 10.6 5.8 8 6.4 2.6 8.8 5.4 10.8 8 12 12Z"></path><path d="M12 12C15 13.4 18.2 16 17.6 21.4 15.2 18.6 13.2 16 12 12Z"></path>`);
