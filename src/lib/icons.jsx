...
export const Trophy = crearIcono("Trophy", `<path d="M7 4h10v5a5 5 0 0 1-10 0Z"></path><path d="M7 5.5H4.8A2.3 2.3 0 0 0 4.8 10H7"></path><path d="M17 5.5h2.2a2.3 2.3 0 0 1 0 4.5H17"></path><path d="M12 14v3"></path><path d="M9 20.5h6"></path><path d="M9.5 17.3c0 1.2 1 2.2 2.5 3.2 1.5-1 2.5-2 2.5-3.2"></path>`);
